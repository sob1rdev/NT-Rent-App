        ...
        <div class="sidebar-content">
            ...
            <ul class="sidebar-menu border-t border-white/10" data-simplebar style="height: calc(100% - 70px);">
                ...
                <li class="sidebar-dropdown">
                    <a href="javascript:void(0)"><i class="mdi mdi-home-city me-2"></i>Filiallar</a>
                    <div class="sidebar-submenu">
                        <ul>
                            <li><a href="/branch/list">Filiallarni ko'rish</a></li>
                            <li><a href="/branch/create">Filial qo'shish</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="sidebar-dropdown">
                    <a href="javascript:void(0)"><i class="mdi mdi-account me-2"></i>Foydalanuvchilar</a>
                    <div class="sidebar-submenu">
                        <ul>
                            <li><a href="/admin/create">Foydalanuvchi qo'shish</a></li>
                            <li><a href="/user/lists">Foydalanuvchilarni ko'rish</a></li>
                        </ul>
                    </div>
                </li>
                        ...
                        <div class="dropdown-menu absolute end-0 m-0 mt-4 z-10 w-44 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 hidden"
                            ...
                            <ul class="py-2 text-start">
                                ...
                                <li>
                                    <a href="/logout"
                                       class="block py-1 px-4 dark:text-white/70 hover:text-green-600 dark:hover:text-white"><i
                                                class="mdi mdi-logout me-2"></i>Chiqish</a>
                                </li>
                            </ul>
                        </div>
                    </li><!--end dropdown-->
        ...
        <div class="container-fluid relative px-3">
            <div class="layout-specing">
                ...
                <div class="flex justify-between items-center">
                    <div>
                        <h5 class="text-xl font-semibold">Assalamu aleykum, <?= (new \App\Session())->getName() ?></h5>
                        <h6 class="text-slate-400">Hush kelibsiz! Sizni kutgan edik.</h6>
                    </div>
                </div>
